 ...
 *-----------------------------------------------------------------------------
 *
 * Implementation of function ssm_strncat_s
 *
 *-----------------------------------------------------------------------------
 *
...
ssm_errno_t ssm_strncat_s (char* s1, ssm_rsize_t s1max, const char* s2, ssm_rsize_t n)
{
    ...
    if (s1 == NULL) {
        ...
        else if ((len2 = ssm_cstring_length(s2, n < m ? n : m)) >= m) {
