 ...
 *-----------------------------------------------------------------------------
 *
 * Implementation of function ssm_strncpy_s
 *
 *-----------------------------------------------------------------------------
 *
...
ssm_errno_t ssm_strncpy_s (char* s1, ssm_rsize_t s1max, const char* s2, ssm_rsize_t n)
{
    ...
    else if ((len = ssm_cstring_length(s2, n)) >= s1max) {
