 ...
 *-----------------------------------------------------------------------------
 *
 * Implementation of function _ssm_sbuffer_set_range
 *
 *-----------------------------------------------------------------------------
 *
...
ssm_status_t _SSM_CANARY_SYMBOL(_ssm_sbuffer_set_range) (ssm_sbuffer_t* buf,
                                                         size_t start,
                                                         size_t length,
                                                         uint8_t value
                                                         _SSM_CANARY_ARG_DECL)
{
    ...
    if (buf == NULL) {
        ...
        ssm_status_t status = ssm_set(buf->_data + start, actualSize, value);
